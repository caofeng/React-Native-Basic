        ...
        <View style={{ alignItems: "center" }}>
          <View style={styles.container2}>
            ...
            <Text
              ...
              onPress={() => {
                this.setState({ checkCodeTextColor: "#AAAAAA" });
                ...
                if (this.state.seconds == 60) {
                  this.timer_interval = setInterval(() => {
                    ...
                    if (this.state.seconds < 1) {
                      this.setState({ checkCodeTextColor: "blue" });
                      this.setState({ checkCodeText: fetchCheckCode });
                      this.setState({ seconds: 60 });
                      this.timer_interval && clearTimeout(this.timer_interval);
                    } else {
                      this.setState({
                        checkCodeText: "还剩余" + this.state.seconds + "s"
                      });
                    }
                  }, 1000);
                }
          ...
          <View
            style={{ backgroundColor: "#CCCCCC", height: 1, width: width - 40 }}
          />
        </View>
      );
    } else {
